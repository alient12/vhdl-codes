...
HD_PWD='C:/Users/Asus/arch_project/arch_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log simple.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source simple.tcl -notrace
